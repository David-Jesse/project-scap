  ...
  return (
    <div>
      ...
      <button
        ...
        className="text-[0.875rem] text-primary underline md:text-[1.24rem]"
      >
        back
      </button>
        ...
        {showSuccessScreen ? (
          ...
          >
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <div>
                <TagInput
                  ...
                  onEnter={(text) => {
                    const exisitingIncludeWords = watchIncludeWords || [];
                    setValue("includeWords", [...exisitingIncludeWords, text]);
                  }}
                  onTagRemove={(word) => {
                    setValue(
                      "includeWords",
            ...
            <button
              ...
              type="submit"
              className="h-[56px] w-full rounded-[40px] bg-primary text-[1rem] font-semibold text-[#fafafa] md:h-[88px] md:text-[1.5rem] md:font-bold"
            >
              create alert
            </button>
          </form>
