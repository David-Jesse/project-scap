...
export const Index = () => {
  ...
  return (
    <main>
      ...
      <img src={recommend} alt="recommend" className="recommend absolute -left-6 -top-[36px] -z-20 h-48 w-36 md:-left-14 md:-top-[36px] md:h-80 md:w-80" />
      <img
        src={recycle}
        id="recycle"
        alt="recycle"
      ...
      <section className="landing-page__text">
        <div className="flex flex-col items-center">
          ...
          <div className="mb-8 overflow-hidden">
            ...
            >
              your automated help in job search. scrapper brings jobs to you and
              you to jobs, no stress.
            </p>
          </div>
