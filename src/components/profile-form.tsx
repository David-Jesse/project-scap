...
const ProfileForm = () => {
  const { user } = useLoaderData({ from: "/_auth_routes" });
  ...
  return (
    <div className="flex justify-center">
      <div className="max-w-[568px] grow">
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <div className="relative">
            ...
            <div className="absolute right-4 top-1/2 flex -translate-y-1/2 gap-4 md:right-8">
              {user.googleId && (
                <div className="text-w flex items-center gap-1 rounded-[40px] bg-form_text px-2 py-2 text-[0.875rem] font-semibold text-white">
